export default {
    ...
    roleID: "", //? The ID of the role the bot gives to a user that has successfully completed the test
    banTime: 1800000, //? The time a user is temporarily banned after failing the test [number] times
